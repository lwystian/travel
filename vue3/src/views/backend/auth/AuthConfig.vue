...
import { getGeetestConfig, getSmsConfig, saveGeetestConfig, saveSmsConfig } from '@/api/authConfig'
...
const loadConfigs = async () => {
  const [sms, geetest] = await Promise.all([getSmsConfig(), getGeetestConfig()])
